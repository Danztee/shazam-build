...
type Querier interface {
	...
	CreateOrGetArtist(ctx context.Context, name string) (Artist, error)
	...
	GetArtistsBySongID(ctx context.Context, songID int32) ([]Artist, error)
	...
	GetSongWithArtists(ctx context.Context, id int32) (GetSongWithArtistsRow, error)
	GetSongsWithArtists(ctx context.Context) ([]GetSongsWithArtistsRow, error)
	LinkSongToArtist(ctx context.Context, arg LinkSongToArtistParams) error
